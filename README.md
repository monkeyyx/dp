...
dp is an extension repo for [SkyStream](https://github.com/akashdh11/skystream). Follow the guide below to get started and set up your providers.
...
4.  Enter the following Repository URL:
    > **Repository URL:** `https://raw.githubusercontent.com/monkeyyx/dp/main/repo.json`
5.  Tap **Add**.
...
1.  **Clone the repo**: `git clone https://github.com/USER_NAME/dp.git`
